...
#include "/g/g20/bacon4/benchmark25/lib/include/vernier.h"
#include <unistd.h>
...
Kokkos::Profiling::pushRegion("Commuicate");

  auto TIME_START = std::chrono::high_resolution_clock::now();

      char x[100];  // writable buffer

    strcpy(x, name);     // copy from const char*
    strcat(x, "_mpi");   // append
...
PRINT_LINE();
  ...
  Kokkos::Profiling::pushRegion("c applys");
    char x[100];  // writable buffer

    strcpy(x, name);     // copy from const char*
    strcat(x, "_cali");   // append
...
Kokkos::Profiling::pushRegion(name);
        Kokkos::Profiling::pushRegion("cabana");
        ...
        Kokkos::Profiling::popRegion();
        Kokkos::Profiling::pushRegion("mpi");
...
//  runBoth("/g/g20/bacon4/sparse/pm/Hook_1498.pm", "Hook_1498.pm");
  ...
  runBoth("dwt_162.pm", "dwt_162.pm");
  runBoth("cage15.pm", "cage15.pm");
  runBoth("dielFilterV2real.pm", "dielFilterV2real.pm");
  runBoth("dielFilterV3real.pm", "dielFilterV3real.pm");
  runBoth("Flan_1565.pm", "Flan_1565.pm");
  runBoth("Geo_1438.pm", "Geo_1438.pm");
  runBoth("Hook_1498.pm", "Hook_1498.pm");
