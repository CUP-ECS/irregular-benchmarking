...
if(CMAKE_C_COMPILER_LOADED)
    ...
    if (HAVE_OPENMP_SIMD)
       set(VECTOR_OPENMP_SIMD_C_FLAGS "${VECTOR_OPENMP_SIMD_C_FLAGS} -D_OPENMP_SIMD")
...
if(CMAKE_CXX_COMPILER_LOADED)
    ...
    if (HAVE_OPENMP_SIMD)
       set(VECTOR_OPENMP_SIMD_CXX_FLAGS "${VECTOR_OPENMP_SIMD_CXX_FLAGS} -D_OPENMP_SIMD")
    else (HAVE_OPENMP_SIMD)
...
if(CMAKE_Fortran_COMPILER_LOADED)
    ...
    if (HAVE_OPENMP_SIMD)
       set(VECTOR_OPENMP_SIMD_Fortran_FLAGS "${VECTOR_OPENMP_SIMD_Fortran_FLAGS} -D_OPENMP_SIMD")
    else (HAVE_OPENMP_SIMD)
